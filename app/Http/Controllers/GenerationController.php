...
class GenerationController extends Controller
{
    ...
    public function generate(Request $request): JsonResponse
    {
        ...
        try {
            ...
            // Note: text_blocks are now auto-generated by GPT-4o, not provided by client
            $designPreferences = null;
            if ($request->has('template_type') || $request->has('keywords')) {
                // Handle font_sizes array (optional, will be auto-generated if not provided)
                $fontSizes = [];
                ...
                $designPreferences = [
                    ...
                    // text_blocks will be auto-generated by OpenAIService::generateStructuredPrompts
                    'font_family' => $request->font_family,
                    'font_sizes' => $fontSizes, // Optional, will be auto-generated if empty
    ...
    public function previewPrompts(Request $request): JsonResponse
    {
        ...
        try {
            ...
            // Note: text_blocks will be auto-generated by generateStructuredPrompts
            $designPreferences = [
            ...
            // Generate prompts using GPT-4 (text blocks will be auto-generated)
    ...
    public function regenerateTemplate(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            // Note: text_blocks will be auto-generated, so we don't accept them from request
            ...
            // text_blocks removed - will be auto-generated by generateStructuredPrompts
            ...
            // Ensure category info is present for text block generation
            ...
            // Regenerate single template (text blocks will be auto-generated)
            $templates = $this->aiService->generateTemplates(
                $category,
                null,
